...
<body>	
	...
	<div class="container">
		<div class="row">
		<form method="post" action="updateAction.jsp?tradeID=<%= tradeID %>">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="글 제목" name="tradeTitle" maxlength="50" value="<%= trade.getTradeTitle()%>"></td>
					</tr>
					<tr>
						<td><textarea class="form-control" placeholder="글 내용" name="tradeContent" maxlength="4096" style="height:350px;"><%=trade.getTradeContent() %></textarea></td>
					</tr>
				</tbody>
			</table>
			<input type="submit" class="btn btn-pripary pull-right" value="글 수정">
		</form>		
		</div> 
	</div>
